import { Ship, Shield, Sparkles, Clock, Phone, Mail, MapPin, Star, ChevronLeft, ChevronRight, Search, Droplet, Sun, Check, AlertCircle, Linkedin, Instagram } from 'lucide-react';
